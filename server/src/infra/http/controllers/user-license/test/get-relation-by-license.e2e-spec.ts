...
describe('Get user-license relationship by license (E2E)', () => {
  beforeAll(async () => {
    await app.ready()
  })
  ...
  it('should return a user-license relationship by license', async () => {
    ...
    const response = await supertest(app.server).get(`/user-licenses/license/${license.id}`)
